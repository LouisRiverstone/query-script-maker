    ...
    <header class="bg-gray-100 dark:bg-gray-900">
        <div class="mx-auto flex  flex-col sm:flex-row p-5 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
            <router-link to="/" class="block text-indigo-600 dark:text-indigo-300">
                ...
                </svg></svg><text fill="#ffffff" font-family="Orbitron" font-size="32px" x="66" y="121"><tspan dy="0" x="66"></tspan></text><text fill="#ffffff" font-family="Arial" font-size="16px" x="66" y="121"><tspan dy="0" x="66"></tspan></text></svg>
            </router-link>
                    ...
                    <ul class="flex items-center gap-6 text-sm sm:flex-row flex-col">
                        ...
                        <li>
                            <router-link to="/config"
                                class="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75">Config</router-link>
                        </li>

                        <li>
                            <a href="/" class="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75" @click="openRepository">Github</a>
                        </li>
                    </ul>
                </nav>
            </div>
